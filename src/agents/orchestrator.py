...
from src.agents.subagents.budgeting.agent import budgeting_agent_tool
from .subagents.financial_profile.agent import financial_profile_agent_tool
...
root_agent = LlmAgent(
    ...
    tools=[linking_agent_tool, budgeting_agent_tool, financial_profile_agent_tool],
